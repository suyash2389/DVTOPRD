...
/**
 * <p>Java class for legendType complex type.
 * 
...
@XmlType(name = "legendType", propOrder = {
    "type",
    "style"
})
public class LegendType {

    @XmlElement(required = true, defaultValue = "interactive")
    protected String type;
    @XmlElement(required = true, defaultValue = "margin: 0 5px 0 5px;")
